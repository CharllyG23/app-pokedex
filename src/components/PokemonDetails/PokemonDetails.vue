<template>
    <teleport to="body">
		<transition name="fade">
			<div v-if="modelValue" class="py-modal">
                           ...
                           <div class="stats">
                                ...
                                <div class="stats pt-4">
                                    <div v-for="(item, index) in info.stats" :key="index">
                                       <div class="flex items-center pt-2 border-b justify-between">
                                            <span class="text-gray-800">{{ formatString(item.stat.name) }} </span>
                                            <span class="text-green-400 font-medium">{{ item.base_stat }} </span>
                                       </div>
                                    </div>
                                </div>
                           </div>
...
const formatStringUppercase = (str) => {
